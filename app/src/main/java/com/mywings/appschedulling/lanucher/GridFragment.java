...
public class GridFragment extends Fragment {
    ...
    final private AdapterView.OnItemLongClickListener mItemLongClickListener = new AdapterView.OnItemLongClickListener() {
        @Override
    ...
    private void ensureGrid() {
        ...
        mGrid.setOnItemLongClickListener(mItemLongClickListener);
        if (mAdapter != null) {
