...
public class AppSchedulingDatabaseHelper extends SQLiteOpenHelper {
    ...
    private final String CREATE_APP_METADATA = "CREATE TABLE IF NOT EXISTS APP_METADATA(id INTEGER PRIMARY KEY AUTOINCREMENT,name text,packagename text,localdirectory text,numoffiles INTEGER,size INTEGER,show text,synced text)";
