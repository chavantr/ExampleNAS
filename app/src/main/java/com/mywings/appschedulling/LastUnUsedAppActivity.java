...
public class LastUnUsedAppActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (Build.VERSION.SDK_INT > Build.VERSION_CODES.LOLLIPOP) {
            ...
            List<UsageStats> stats = mUsageStatsManager.queryUsageStats(UsageStatsManager.INTERVAL_WEEKLY, currentTime - 100 * 7000, currentTime);
            if (stats != null) {
        ...
        unUsedAppsAdapter = new UnUsedAppsAdapter(lstAppModel);
